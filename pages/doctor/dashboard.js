...
export default function Dashboard(){
    ...
    return (
        ...
        <div className="flex flex-col">
          <h3 className="px-2">Doctors Dashboard</h3>
      <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          ...
          <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {appn.length == 0 && <div>No appointment yet</div>}
                {appn.map((person,i) => (
                  <tr key={i}>
        ...
        //         return (
        //             <div key={i}>
        //                 <p>{a.day} - {moment(a.date).format('MM/DD/YYYY')} - {a.time}</p>
        //                 <p>{a.total} - {a.pending} - {a.completed}</p>
                        // <Link href="/appointment/doctor/details/[id]" as={`/appointment/doctor/details/${a._id}`}>
                        //     <a>Details</a>
                        // </Link>
        //             </div>
        //         )
